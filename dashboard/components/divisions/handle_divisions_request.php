...
function add_division() {
  ...
  $result = DivisionsDatabase::insert_division($division_name, $division_mode, $division_min_teams, $division_max_teams, $division_category);
  
  if ($result) {
    $division = DivisionsDatabase::get_division_by_name($division_name, $division_mode, $division_category);
