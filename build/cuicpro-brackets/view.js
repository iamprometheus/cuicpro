...
(() => {
  ...
  \*********************/
	...
	/* harmony import */ var _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__ =
		__webpack_require__(
	...
	const { state } = (0,
	_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)(
		"cuicpro-brackets",
		{
			state: {
				isBracketOpen: false,
			...
			actions: {
				toggleBracket() {
					...
					for (const key in context.bracketsState) {
						...
						if (key.startsWith("bracketId_"))
							context.bracketsState[key] = false;
					}
