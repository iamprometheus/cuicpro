...
Class MatchesDatabase {
    ...
    public static function create_matches_table() {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}cuicpro_matches (
            ...
            goals_team_1 INT UNSIGNED NOT NULL,
            goals_team_2 INT UNSIGNED NOT NULL,
            match_winner SMALLINT UNSIGNED NOT NULL,
    ...
    public static function insert_match(int $tournament_id, int $division_id,  int $bracket_id, int $field_number, int $team_id_1, int $team_id_2, string $match_date, string $match_time, int $goals_team_1, int $goals_team_2, int $match_winner, int $bracket_match, int $official_id ) {
        global $wpdb;
        $result = $wpdb->insert(
    ...
    public static function update_match(int $match_id, int $team_id_1, int $team_id_2, int $goals_team_1, int $goals_team_2, int $match_winner ) {
