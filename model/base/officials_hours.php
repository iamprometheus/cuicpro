...
class OfficialsHoursDatabase
{
  ...
  public static function update_official_day(int $official_hours_id, string $official_day)
  {
    global $wpdb;
    $result = $wpdb->update(
      $wpdb->prefix . 'cuicpro_officials_hours',
    ...
    if ($result) {
      return "Official day updated successfully";
    }
    return "Official day not updated. Please try again.";
  }
