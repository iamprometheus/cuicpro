...
class BracketsDatabase
{
    ...
    public static function create_brackets_table()
    {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}cuicpro_brackets (
            ...
            has_populated_playoffs BOOLEAN NOT NULL,
    ...
    public static function update_bracket_populated_playoffs(int $bracket_id, int $has_populated_playoffs)
    {
        global $wpdb;
        $result = $wpdb->update(
            $wpdb->prefix . 'cuicpro_brackets',
            array(
                'has_populated_playoffs' => $has_populated_playoffs,
            ),
            array(
                'bracket_id' => $bracket_id,
            )
        ...
        if ($result) {
            return "Bracket populated playoffs status updated successfully";
        }
        return "Bracket populated playoffs status not updated";
    }
