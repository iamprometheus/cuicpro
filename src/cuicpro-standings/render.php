...
if (!function_exists('render_team_selector_standings')) {
	function render_team_selector_standings() {
		...
		$html .= "<select id='tournament-select-standings' value='" . esc_attr($first_tournament->tournament_id) . "'>";
		...
		$html .= "<select id='division-select-standings' value='" . esc_attr($divisions_last_tournament[0]->division_id) . "'>";
		...
		$html .= "<select id='team-select-standings'>";
...
<div
	...
	data-wp-interactive="cuicpro-standings"
	>
	<div class="schedules-container">
		<?php
			echo render_team_selector_standings();
		?>
		<div id="team-standings" class="team-standings">
